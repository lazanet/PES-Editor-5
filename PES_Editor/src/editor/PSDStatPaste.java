...
public class PSDStatPaste extends JDialog 
{
	...
	public static final String[] nationalities = { "Austrian", "Belgian", "Bulgarian", "Croatian", "Czech", "Danish", "English", "Finnish", "French", "German", "Greek", "Hungarian", "Irish", "Italian", "Latvia", "Dutch", "Northern Irish", "Norwegian", "Polish", "Portuguese", "Romanian", "Russian", "Scottish", "Serbian", "Slovak", "Slovenian", "Spanish", "Swedish", "Swiss", "Turkish", "Ukrainian", "Welsh", "Cameroonian", "Ivorian", "Moroccan", "Nigerian", "Senegal", "South Africa", "Tunisia", "Costa Rican", "Mexican", "American", "Argentinian", "Brazilian", "Chilean", "Colombian", "Ecuadorian", "Paraguayan", "Peruvian", "Uruguayan", "Venezuelan", "China", "Iran", "Japanese", "Saudi Arabia", "South Korean", "Australian", "Albanian", "Armenia", "Belarusian", "Bosnian", "Cyprus", "Georgian", "Estonia", "Faroe Islands", "Icelandic", "Israeli", "Lithuania", "Luxembourg", "Macedonian", "Moldova", "Honduran", "Algerian", "Angola", "Burkina Faso", "Cape Verde", "Congo", "DR Congo", "Egypt", "Equatorial Guinea", "Gabon", "Gambia", "Ghanian", "Guinea", "Guinea-Bissau", "Liberia", "Libya", "Mali", "Mauritius", "Mozambique","Namibia", "Sierra Leone", "Togo", "Zambia", "Zimbabwean", "Canadian", "Grenada", "Guadeloupe", "Guatemala", "Honduran", "Jamaican", "Martinique", "Netherlands Antilles", "Panama", "Trinidadian", "Bolivian", "Guyana", "Uzbekistan", "New Zealand", "Free Nationality" };
	...
	private void sendPSD(String s)
	{
		...
		for (int i = 0; i < positionNames[0].length; i++)
		...
		retForm.genPanel.consBox.setSelectedIndex(0);
					...
					if (strIn(f,"Nationality"))
					{
						...
						for (int k=0; k<nationalities.length; k++)
							if (nation.toUpperCase().equals(nationalities[k].toUpperCase()))
								{ index = k; break;}
						String normalNation = Stat.nation[index];
